...
{
    class AddCollectionAndFindHotelTest:BaseTest
    {
        ...
        public void DetailHotel()
        {
            ...
            string nameOfFirstHotel = searchPage.GetHotelName(1);
            string locationOfFirstHotel = searchPage.GetHotelAddress(1);
            ...
            Assert.AreEqual(nameOfDetailHotel, nameOfFirstHotel);
            StringAssert.Contains(locationOfFirstHotel, locationOfDetailHotel);
        }
        [Test]
